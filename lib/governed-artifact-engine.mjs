...
export const DEFAULT_CONFORMANCE_PROFILE_PATH = path.join(
  packageRoot,
  "profiles",
  "closed-world-artifact-conformance.v6.json"
);
...
export const ENGINE_IDENTITY = "governed-artifact-engine.0.14.1";
...
function validateConformanceProfile(profile) {
  ...
  if (
    profile.profileType !== "governed-artifact-conformance-profile.v6" ||
  ...
  if (
    ...
    !["authority-closure-verifier.v1", "source-token-structure-verifier.v1"].every(
      (verifierId) =>
