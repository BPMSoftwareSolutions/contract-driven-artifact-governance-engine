...
export const DEFAULT_CONFORMANCE_PROFILE_PATH = path.join(
  packageRoot,
  "profiles",
  "closed-world-artifact-conformance.v5.json"
);
...
export const ENGINE_IDENTITY = "governed-artifact-engine.0.13.0";
...
function validateConformanceProfile(profile) {
  ...
  if (
    profile.profileType !== "governed-artifact-conformance-profile.v5" ||
